...
public class UserSettingRecord extends UpdatableRecordImpl<UserSettingRecord> implements Record6<Integer, AlertType, Boolean, String, Boolean, Boolean> {
     ...
     */
    @Override
    public Row6<Integer, AlertType, Boolean, String, Boolean, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row6<Integer, AlertType, Boolean, String, Boolean, Boolean> valuesRow() {
     ...
     */
    @Override
    public UserSettingRecord values(Integer value1, AlertType value2, Boolean value3, String value4, Boolean value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserSettingRecord(Integer id, AlertType alertType, Boolean isDisabled, String userId, Boolean sendNotice, Boolean sendEmail) {
        super(UserSetting.USER_SETTING);
