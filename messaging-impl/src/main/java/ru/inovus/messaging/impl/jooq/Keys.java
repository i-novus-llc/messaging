...
public class Keys {
    ...
    public static final UniqueKey<MessageTemplateRecord> MESSAGE_SETTING_PKEY = UniqueKeys0.MESSAGE_SETTING_PKEY;
    ...
    public static final ForeignKey<MessageTemplateRecord, ChannelRecord> MESSAGE_TEMPLATE__MESSAGE_SETTING_CHANNEL_ID_CHANNEL_ID_FK = ForeignKeys0.MESSAGE_TEMPLATE__MESSAGE_SETTING_CHANNEL_ID_CHANNEL_ID_FK;
    public static final ForeignKey<MessageTemplateRecord, TenantRecord> MESSAGE_TEMPLATE__MESSAGE_SETTING_TENANT_CODE_FKEY = ForeignKeys0.MESSAGE_TEMPLATE__MESSAGE_SETTING_TENANT_CODE_FKEY;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<MessageTemplateRecord> MESSAGE_SETTING_PKEY = Internal.createUniqueKey(MessageTemplate.MESSAGE_TEMPLATE, "message_setting_pkey", new TableField[] { MessageTemplate.MESSAGE_TEMPLATE.ID }, true);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<MessageTemplateRecord, ChannelRecord> MESSAGE_TEMPLATE__MESSAGE_SETTING_CHANNEL_ID_CHANNEL_ID_FK = Internal.createForeignKey(Keys.CHANNEL_PKEY, MessageTemplate.MESSAGE_TEMPLATE, "message_setting_channel_id_channel_id_fk", new TableField[] { MessageTemplate.MESSAGE_TEMPLATE.CHANNEL_ID }, true);
        public static final ForeignKey<MessageTemplateRecord, TenantRecord> MESSAGE_TEMPLATE__MESSAGE_SETTING_TENANT_CODE_FKEY = Internal.createForeignKey(Keys.TENANT_PKEY, MessageTemplate.MESSAGE_TEMPLATE, "message_setting_tenant_code_fkey", new TableField[] { MessageTemplate.MESSAGE_TEMPLATE.TENANT_CODE }, true);
    }
}
