...
public class MessageSetting extends TableImpl<MessageSettingRecord> {
    ...
    private static final long serialVersionUID = -365321767;
    ...
    /**
     * The column <code>public.message_setting.info_type</code>. Вид информирования по событию (почта, центр уведомления)
     */
    public final TableField<MessageSettingRecord, InfoType> INFO_TYPE = createField("info_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "Вид информирования по событию (почта, центр уведомления)", new InfoTypeConverter());
