...
public class MessageSettingRecord extends UpdatableRecordImpl<MessageSettingRecord> implements Record11<Integer, String, String, Severity, AlertType, Integer, String, Boolean, FormationType, Boolean, Boolean> {
     ...
     */
    @Override
    public Row11<Integer, String, String, Severity, AlertType, Integer, String, Boolean, FormationType, Boolean, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row11<Integer, String, String, Severity, AlertType, Integer, String, Boolean, FormationType, Boolean, Boolean> valuesRow() {
     ...
     */
    @Override
    public MessageSettingRecord values(Integer value1, String value2, String value3, Severity value4, AlertType value5, Integer value6, String value7, Boolean value8, FormationType value9, Boolean value10, Boolean value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageSettingRecord(Integer id, String caption, String text, Severity severity, AlertType alertType, Integer componentId, String name, Boolean isDisabled, FormationType formationType, Boolean sendNotice, Boolean sendEmail) {
        super(MessageSetting.MESSAGE_SETTING);
