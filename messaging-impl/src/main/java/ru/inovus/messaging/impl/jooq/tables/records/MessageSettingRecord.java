...
public class MessageSettingRecord extends UpdatableRecordImpl<MessageSettingRecord> implements Record12<Integer, String, String, Severity, AlertType, Integer, String, String, Boolean, FormationType, Boolean, Boolean> {

    private static final long serialVersionUID = 346628518;
    ...
    /**
     * Setter for <code>public.message_setting.code</code>.
     */
    ...
    /**
     * Getter for <code>public.message_setting.code</code>.
     */
     ...
     */
    @Override
    public Row12<Integer, String, String, Severity, AlertType, Integer, String, String, Boolean, FormationType, Boolean, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row12<Integer, String, String, Severity, AlertType, Integer, String, String, Boolean, FormationType, Boolean, Boolean> valuesRow() {
     ...
     */
    @Override
    public MessageSettingRecord value12(Boolean value) {
        setSendEmail(value);
        return this;
    }
     ...
     */
    @Override
    public MessageSettingRecord values(Integer value1, String value2, String value3, Severity value4, AlertType value5, Integer value6, String value7, String value8, Boolean value9, FormationType value10, Boolean value11, Boolean value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageSettingRecord(Integer id, String caption, String text, Severity severity, AlertType alertType, Integer componentId, String name, String code, Boolean isDisabled, FormationType formationType, Boolean sendNotice, Boolean sendEmail) {
        super(MessageSetting.MESSAGE_SETTING);
