...
public class RecipientRecord extends UpdatableRecordImpl<RecipientRecord> implements Record4<Integer, String, String, LocalDateTime> {

    private static final long serialVersionUID = 1840120021;
     ...
     */
    @Override
    public RecipientRecord values(Integer value1, String value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RecipientRecord(Integer id, String recipient, String messageId, LocalDateTime readAt) {
        super(Recipient.RECIPIENT);
